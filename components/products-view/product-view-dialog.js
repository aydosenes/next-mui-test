...
import useShoppingCart from "hooks/useShoppingCart"; // CUSTOM UTILS LIBRARY FUNCTION
        ...
        <div>
          <Grid container spacing={3}>
            ...
            <Grid item md={6} xs={12} alignSelf="center">
              ...
              {!cartItem?.quantity ? <Button size="large" color="primary" variant="contained" onClick={handleCartAmountChange(1)} sx={{
              height: 45
            }}>
                  {t('Add To Cart')}
